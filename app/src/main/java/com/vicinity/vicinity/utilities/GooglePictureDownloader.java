...
//    private IDownloadImageListener caller;
    ...
    private static GooglePictureDownloader instance;

    public static GooglePictureDownloader getInstance(){
        if (instance == null){
            instance = new GooglePictureDownloader();
        }
        return instance;
    }

    private GooglePictureDownloader() {
...
//                GooglePictureDownloader.this.caller.onImageDownloaded(bitmap);
     ...
     * @param avatarURL
     */
    public void setBitmap(String avatarURL, final QueryProcessor.CustomPlace.Review review){
        URL url = null;
        try {
